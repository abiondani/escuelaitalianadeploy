...
exports.addAlumno = async (req, res) => {
  try {
    ...
    console.log("Error interno del servidor al dar de alta un alumno\n", err);
...
exports.delAlumno = async (req, res) => {
  try {
    ...
    console.log("Error interno del servidor al dar de baja un alumno\n", err);
    res.status(500).render("admin/listAlumno", {
      error: "Error interno del servidor",
      usuario: req.params.usuario,
    });
...
exports.updateAlumno = async (req, res) => {
  try {
    const { _id, nombre, apellido, usuarioId, usuarioNombre, usuarioClave } =
      req.body;
    ...
    console.log("Error interno del servidor al actualizar un alumno\n", err);
    res.status(500).render("admin/editAlumno", {
      error: "Error interno del servidor",
      alumno: alumno,
      usuario: req.params.usuario,
